...
CREATE TABLE `dz5`.`stashion` (
  `train_id_integer` INT NOT NULL,
  `station_name` VARCHAR(45) NOT NULL,
  `station_time` TIME NOT NULL);
  
INSERT INTO `dz5`.`stashion` (`train_id_integer`, `station_name`, `station_time`) VALUES ('110', 'СанФранциско', '10:00:00');
INSERT INTO `dz5`.`stashion` (`train_id_integer`, `station_name`, `station_time`) VALUES ('110', 'РедвуСити', '10:54:00');
INSERT INTO `dz5`.`stashion` (`train_id_integer`, `station_name`, `station_time`) VALUES ('110', 'ПалоАльто', '11:02:00');
INSERT INTO `dz5`.`stashion` (`train_id_integer`, `station_name`, `station_time`) VALUES ('110', 'СанХосе', '12:35:00');
INSERT INTO `dz5`.`stashion` (`train_id_integer`, `station_name`, `station_time`) VALUES ('120', 'СанФранциско', '11:00:00');
INSERT INTO `dz5`.`stashion` (`train_id_integer`, `station_name`, `station_time`) VALUES ('120', 'ПалоАльто', '12:49:00');
INSERT INTO `dz5`.`stashion` (`train_id_integer`, `station_name`, `station_time`) VALUES ('120', 'СанХосе', '13:30:00');
